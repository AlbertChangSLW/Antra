...
--6.
--I can use union or intersect two table and check the number of records is the same one table.
--I also can use Except to minus two table and check the number of records will become null
--I also can use join to combine two table and check if there is null value, but this way need to check each column